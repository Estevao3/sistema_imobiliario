...
mix
    ...
    .styles([
        ...
        'resources/views/admin/assets/js/js/datatables/css/responsive.dataTables.min.css',
    ...
    .scripts([
        'resources/views/admin/assets/js/tinymce.min.js',
        'resources/views/admin/assets/js/jquery.dataTables.min.js',
        'resources/views/admin/assets/js/dataTables.responsive.min.js',
        'resources/views/admin/assets/js/select2.min.js',
        'resources/views/admin/assets/js/i18n/pt-BR.js',
    ...
    .copyDirectory('resources/views/admin/assets/js/datatables', 'public/backend/assets/datatables')
    .copyDirectory('resources/views/admin/assets/js/select2', 'public/backend/assets/select2')
    .copyDirectory('resources/views/admin/assets/js/tinymce', 'public/backend/assets/tinymce')
